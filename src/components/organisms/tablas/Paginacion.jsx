 ...
 return (
    <Container $bgCategoria={bgCategoria} $colorCategoria={colorCategoria}>
      ...
      <button disabled={pagina === 1 || pagina < 1} onClick={previousPage}>
        <span className="iconoIzquierda"><v.iconoFlechaderecha /></span> {/* CORREGIDO: "F" mayúscula */}
      </button>
      ...
      <button
        ...
        onClick={nextPage}
      >
        <span><v.iconoFlechaderecha /></span> {/* CORREGIDO: "F" mayúscula */}
      </button>
    </Container>
  );
};
